...
import { defineComponent, ref, onMounted, createSSRApp, useSSRContext, mergeProps, resolveComponent, withCtx, createTextVNode, toDisplayString } from "vue";
...
_sfc_main$8.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppOffcanvasToggle.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const AppOffCanvasToggle = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$7 = {
  name: "AppNavbar",
  components: {
    AppOffCanvasToggle
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_app_off_canvas_toggle = resolveComponent("app-off-canvas-toggle");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "navbar" }, _attrs))}><div class="container"><a class="navbar-brand" href="#">Jedison</a>`);
  _push(ssrRenderComponent(_component_app_off_canvas_toggle, null, null, _parent));
  _push(`</div></div>`);
}
const _sfc_setup$7 = _sfc_main$7.setup;
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppNavbar.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const AppNavbar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$6 = {
  name: "AppPagesNav",
  computed: {
    routes() {
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${ssrRenderAttrs(mergeProps({ class: "offcanvas-body" }, _attrs))}><ul class="navbar-nav me-auto mb-2 mb-lg-0"><!--[-->`);
  ssrRenderList($options.routes, (route) => {
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppPagesNav.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const AppPagesNav = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$5 = {
  name: "AppOffCanvas",
  components: {
    AppPagesNav
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_app_pages_nav = resolveComponent("app-pages-nav");
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "offcanvasNavbar",
    class: "offcanvas offcanvas-start",
    tabindex: "-1",
    "aria-labelledby": "offcanvasNavbarLabel"
  }, _attrs))}><div class="offcanvas-body">`);
  _push(ssrRenderComponent(_component_app_pages_nav, null, null, _parent));
  _push(`</div></div>`);
}
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppOffcanvas.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const AppOffCanvas = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$4 = {
  components: {
    AppNavbar,
    AppOffCanvas
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_app_navbar = resolveComponent("app-navbar");
  const _component_app_off_canvas = resolveComponent("app-off-canvas");
  const _component_router_view = resolveComponent("router-view");
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_app_navbar, null, null, _parent));
  _push(ssrRenderComponent(_component_app_off_canvas, null, null, _parent));
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4]]);
...
class RefParser {
  ...
  async collectRefs(schema, path = "#") {
    ...
    for (const [key, value] of Object.entries(schema)) {
      ...
      if (this.hasRef(schema)) {
        ...
        if (this.isExternalRef(ref2)) {
          const resolvedSchema = await this.load(ref2);
          this.refs[ref2] = resolvedSchema;
          await this.collectRefs(resolvedSchema, nextPath);
        } else {
          this.refs[ref2] = this.data[ref2] ?? null;
        }
      }
  ...
  isExternalRef(ref2) {
    ...
    return ref2.startsWith("http") || ref2.startsWith("https");
  }
  isObject(value) {
    ...
    function checkRef(path, visited, stack) {
      if (visited.has(path)) {
        ...
        if (cycleStartIndex !== -1) {
          ...
          const minIndex = cyclePath.reduce((minIdx, ref2, idx) => ref2 < cyclePath[minIdx] ? idx : minIdx, 0);
  ...
  expand(schema) {
    ...
    if (this.isObject(cloneSchema) && this.hasRef(cloneSchema)) {
      const ref2 = cloneSchema.$ref;
      delete cloneSchema["$ref"];
      return this.expand(mergeDeep({}, this.refs[ref2], cloneSchema));
    }
    return cloneSchema;
  }
...
class Theme {
  ...
  getEditorContainer() {
    ...
    html2.classList.add("jedi-editor-container");
    return html2;
  }
  /**
   ...
   */
  getFieldset() {
    const html2 = document.createElement("fieldset");
    html2.classList.add("jedi-editor-fieldset");
    html2.setAttribute("role", "group");
    return html2;
  }
  /**
  ...
  getCard() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-editor-card");
    return html2;
  }
  /**
   * Header for cards
  ...
  getCardHeader() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-editor-card-header");
    return html2;
  }
  /**
  ...
  getCardBody() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-editor-card-body");
    return html2;
  }
  /**
  ...
  getActionsSlot() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-actions-slot");
    return html2;
  }
  /**
  ...
  getArrayActionsSlot() {
    ...
    html2.classList.add("jedi-array-actions-slot");
    return html2;
  }
  /**
  ...
  getChildrenSlot() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-children-slot");
    return html2;
  }
  /**
  ...
  getMessagesSlot(config = {}) {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-messages-slot");
    html2.setAttribute("aria-atomic", "false");
    html2.setAttribute("aria-live", "polite");
    if (config.id) {
      html2.setAttribute("id", config.id);
    }
    return html2;
  }
  /**
  ...
  getControlSlot() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-control-slot");
    return html2;
  }
  /**
  ...
  getPropertiesSlot(config) {
    const html2 = document.createElement("dialog");
    html2.classList.add("jedi-properties-slot");
    html2.setAttribute("id", config.id);
    window.addEventListener("click", (event) => {
      if (event.target === html2) {
        html2.close();
      }
    });
    return html2;
  ...
  getPropertiesAriaLive() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-properties-aria-live");
    html2.setAttribute("role", "status");
    html2.setAttribute("aria-live", "polite");
    return html2;
  }
  /**
  ...
  getAriaLiveMessage(message) {
    ...
    html2.classList.add("jedi-aria-live-message");
    html2.textContent = message;
    this.visuallyHidden(html2);
    return html2;
  }
  /**
  ...
  getPropertiesActivators() {
    const html2 = document.createElement("div");
    html2.classList.add("jedi-properties-activators");
    return html2;
  }
  /**
   * Wrapper buttons
  ...
  getBtnGroup() {
    const html2 = document.createElement("span");
    html2.classList.add("jedi-btn-group");
    return html2;
  }
  /**
   * A button
  ...
  getAddPropertyButton(config) {
    const html2 = this.getButton(config);
    html2.classList.add("jedi-add-property-btn");
    return html2;
  }
  /**
  ...
  getArrayBtnAdd(config) {
    const html2 = this.getButton({
      content: config.content,
      icon: "add"
    });
    html2.classList.add("jedi-array-add");
    return html2;
  }
  /**
  ...
  getInvalidFeedback(config) {
    ...
    html2.classList.add("jedi-error-message");
    html2.appendChild(invalidFeedbackIcon);
    html2.appendChild(invalidFeedbackText);
    return html2;
  }
  /**
...
class ThemeBootstrap5 extends Theme {
  ...
  getCardHeader(config) {
    const html2 = super.getCardHeader(config);
    html2.classList.add("card-header");
    html2.classList.add("d-flex");
    html2.classList.add("justify-content-end");
    html2.classList.add("align-items-center");
    html2.classList.add("py-1");
    return html2;
  }
  getCardBody() {
    const html2 = super.getCardBody();
    html2.classList.add("card-body");
    html2.classList.add("pb-0");
    return html2;
  }
  getControlSlot() {
  ...
  getBtnGroup() {
    const html2 = super.getBtnGroup();
    html2.classList.add("btn-group");
    return html2;
  }
  getButton(config) {
    const html2 = super.getButton(config);
    html2.classList.add("btn");
    html2.classList.add("btn-sm");
    return html2;
  }
  getDescription(config) {
  ...
  getAlert(config) {
    const html2 = super.getAlert(config);
    html2.classList.add("alert");
    html2.classList.add("alert-danger");
    return html2;
  }
  getInvalidFeedback(config) {
    const html2 = super.getInvalidFeedback(config);
    html2.classList.add("text-danger");
    html2.classList.add("d-block");
    html2.classList.add("form-text");
    html2.classList.add("form-text");
    return html2;
  }
  getRow() {
...
const _sfc_main$3 = {
  ...
  methods: {
    async init() {
      ...
      const refParser = new index$1.RefParser();
      await refParser.dereference(this.schema);
      const editorOptions = {
        container: this.$refs["editor"],
        theme: new index$1.ThemeBootstrap5(),
        refParser,
      ...
      this.editor = new index$1.Create(editorOptions);
      this.editor.on("change", () => {
        this.$emit("change", this.editor.getValue());
        this.errors = this.editor.getErrors();
      });
      this.errors = this.editor.getErrors();
      this.$emit("ready");
    },
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div></div></div>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppEditor.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const AppEditor = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$2 = {
  name: "HtmlCodeMirrorEditor",
  props: {
    value: {
      // Changed from modelValue to value
      type: String,
  ...
  emits: ["change"],
  // Changed from update:modelValue to change
  data() {
    return {
      editorView: null
    };
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/AppCodemirror.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const AppCodemirror = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_app_codemirror = resolveComponent("app-codemirror");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><h1>Getting Started</h1><p> Editor should remove all properties that are not listed in properties or patternProperties when the option enforceAdditionalProperties or the schema x- option enforceAdditionalProperties is true </p><ul class="nav nav-tabs" role="tablist"><li class="nav-item" role="presentation"><button class="nav-link" id="code-tab" data-bs-toggle="tab" data-bs-target="#code" type="button" role="tab" aria-controls="code" aria-selected="true">Code</button></li><li class="nav-item" role="presentation"><button class="nav-link active" id="preview-tab" data-bs-toggle="tab" data-bs-target="#preview" type="button" role="tab" aria-controls="preview" aria-selected="false">Preview</button></li></ul><div class="tab-content"><div class="tab-pane" id="code" role="tabpanel" aria-labelledby="code-tab">`);
  _push(ssrRenderComponent(_component_app_codemirror, {
    class: "mb-3",
    value: $data.srcDoc,
    onChange: $options.handleEditorChange
  }, null, _parent));
  _push(`</div><div class="tab-pane active" id="preview" role="tabpanel" aria-labelledby="preview-tab"><iframe class="mb-3"${ssrRenderAttr("srcDoc", $data.srcDoc)} title="output" sandbox="allow-scripts" frameBorder="0" width="100%" height="800px"></iframe></div></div></div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/GettingStarted.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const GettingStarted = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
hljs.addPlugin(new CopyButtonPlugin({
  autohide: false
}));
const _sfc_main = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_app_codemirror = resolveComponent("app-codemirror");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><h1>enforceAdditionalProperties</h1><p> Editor should remove all properties that are not listed in properties or patternProperties when the option enforceAdditionalProperties or the schema x- option enforceAdditionalProperties is true </p><ul class="nav nav-tabs" role="tablist"><li class="nav-item" role="presentation"><button class="nav-link" id="code-tab" data-bs-toggle="tab" data-bs-target="#code" type="button" role="tab" aria-controls="code" aria-selected="true">Code</button></li><li class="nav-item" role="presentation"><button class="nav-link active" id="preview-tab" data-bs-toggle="tab" data-bs-target="#preview" type="button" role="tab" aria-controls="preview" aria-selected="false">Preview</button></li></ul><div class="tab-content"><div class="tab-pane" id="code" role="tabpanel" aria-labelledby="code-tab">`);
  _push(ssrRenderComponent(_component_app_codemirror, {
    class: "mb-3",
    value: $data.srcDoc,
    onChange: $options.handleEditorChange
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/EnforceAdditionalProperties.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const EnforceAdditionalProperties = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
const routes = [
  {
    path: "/",
  ...
  {
    path: "/enforceAdditionalProperties",
    name: "enforceAdditionalProperties",
    component: EnforceAdditionalProperties,
    meta: {
      navbar: true
    }
  }
