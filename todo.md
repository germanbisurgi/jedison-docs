## general rules
- follow naming and code conventions found in other files


## todo

- Based on code code examples add the documentation page for the number range editor at the right place
- Create html page in the relative asset folder and use it in Use app-live-example
